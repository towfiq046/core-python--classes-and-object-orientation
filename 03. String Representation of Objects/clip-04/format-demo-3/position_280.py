class Position:
    ...
    def __str__(self):
        # Convention we should follow, the default format invocation where format_spec is empty string,
        # we should give as the same result as the __str__.
        return format(self)

    def __format__(self, format_spec):
        component_format_spec = ".2f"  # Default value. If not provided its empty string.
