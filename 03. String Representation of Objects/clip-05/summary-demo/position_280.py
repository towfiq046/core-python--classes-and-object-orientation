...
print(repr(everest))
print(str(everest))
print(format(everest))
print(format(everest, '.4'))
print(f'{everest:.4}')
print(f'{everest!r}')  # We can force the use of __repr__ from f strings using !r.
print(f'{everest!s}')  # We can force the use of __str__ from f strings using !s.

print(f'{everest = }')  # Recent feature in python, ability to display a variable name and its repr value.
