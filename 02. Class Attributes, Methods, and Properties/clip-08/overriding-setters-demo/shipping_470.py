...
class HeatedRefrigeratedShippingContainer(RefrigeratedShippingContainer):
    ...
    # This is bit of a mess, two direct reference to the base class.
    # Learning this technique is useful when we are not is a position to modify the base class.
    @RefrigeratedShippingContainer.celsius.setter
    def celsius(self, value):
        if value < HeatedRefrigeratedShippingContainer.MIN_CELSIUS:
            raise ValueError("Temperature too cold!")
        RefrigeratedShippingContainer.celsius.fset(self, value)
        # self encapsulation which comes with low price of not having to type _ everywhere easily pays for itself.
