...
class RefrigeratedShippingContainer(ShippingContainer):
    ...
    @property
    def volume_ft3(self):
        # Having important rules defined more than once in the same code base is bad practice.
        return (
            self.length_ft
...
r = RefrigeratedShippingContainer.create_empty('DFK', length_ft=20, celsius=-10)
print(r.volume_ft3)
